...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            ...
            url: "https://github.com/signalseal/ios-signalseal-sdk/releases/download/v0.0.3/SignalSealAttributionSDK.xcframework.zip",
            checksum: "e113097ac948f060db5de4e6fe3f90132ac9915875337e97a5d11777e5b284d1"
        ),
